        ...
        <div class="form-three widget-shadow">
            ...
            <form class="form-horizontal" name="product" action="{{url('admin/shop/product ')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="priceCore" class="form-control1" value="{{old('priceCore')}}" id="focusedinput" >
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="priceSale" class="form-control1" value="{{old('priceSale')}}" id="focusedinput" >
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="stock" class="form-control1" value="{{old('stock')}}" id="focusedinput" >
                    </div>
                </div>
