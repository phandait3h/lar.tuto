        ...
        <div class="form-three widget-shadow">
            ...
            <form class="form-horizontal" name="product" action="{{url('admin/shop/product/'.$products->id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><textarea name="intro" id="txtarea1" cols="50" rows="4"  class="form-control1 mytinymce">{{$products->intro}}</textarea></div>
                </div>
                <div class="form-group">
                    <label for="txtarea1" class="col-sm-2 control-label">Mô tả</label>
                    <div class="col-sm-8"><textarea name="desc" id="txtarea1" cols="50" rows="4"  class="form-control1 mytinymce">{{$products->desc}}</textarea></div>
                </div>
                <div class="form-group">
